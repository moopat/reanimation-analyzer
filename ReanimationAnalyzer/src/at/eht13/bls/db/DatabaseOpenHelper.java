...
public class DatabaseOpenHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		StringBuilder query = new StringBuilder("CREATE TABLE IF NOT EXISTS trainings (");
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		/*
		 * In this method you can compare the old and new version and 
		 * make changes to the database if required.
		 */
